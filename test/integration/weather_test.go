...
func TestShouldReturnTemperatureInCelsiusFahrenheitAndKelvin(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/calculate-temperature?zipcode=01001000", nil)
...
func TestShouldReturnErrorWhenZipcodeIsInvalid(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/calculate-temperature?zipcode=123", nil)
...
func TestShouldReturnErrorWhenZipcodeIsNotFound(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/calculate-temperature?zipcode=12345678", nil)
